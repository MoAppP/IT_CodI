...
public class LoadingActivity extends Activity {
    ...
    private void insertClothes(){
        ...
        Bitmap bitmap23 = decodeSampledBitmapFromResource(getResources(), R.drawable.codi5_accessory2, 2000, 2000);
        Clothes clothes23 = new Clothes(bitmap23, "악세서리", "", "", "가을","겨울",getString(R.string.casual),"더블링 목걸이",false);
        DB.clothesDao().insert(clothes23);

        Bitmap bitmap24 = decodeSampledBitmapFromResource(getResources(), R.drawable.codi5_outer, 2000, 2000);
        ...
        Bitmap bitmap25 = decodeSampledBitmapFromResource(getResources(), R.drawable.codi5_pants, 2000, 2000);
        Clothes clothes25 = new Clothes(bitmap25, "하의", "", "", "가을","겨울",getString(R.string.casual),"블랙 스웨트 팬츠",false);
        DB.clothesDao().insert(clothes25);

        Bitmap bitmap26 = decodeSampledBitmapFromResource(getResources(), R.drawable.codi5_shoes, 2000, 2000);
        Clothes clothes26 = new Clothes(bitmap26, "신발", "", "", "가을","겨울",getString(R.string.casual),"컨버스 하이",false);
        DB.clothesDao().insert(clothes26);

        Bitmap bitmap27 = decodeSampledBitmapFromResource(getResources(), R.drawable.codi5_top, 2000, 2000);
        ...
        Bitmap bitmap28 = decodeSampledBitmapFromResource(getResources(), R.drawable.codi6_accessory, 2000, 2000);
        ...
        Bitmap bitmap41 = decodeSampledBitmapFromResource(getResources(), R.drawable.codi8_top, 2000, 2000);
